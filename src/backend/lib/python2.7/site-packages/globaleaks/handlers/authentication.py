...
def authenticated(role):
    ...
    def wrapper(method_handler):
        def call_handler(cls, *args, **kwargs):
            ...
            if role == 'mixed' and (cls.current_user.user_role == 'receiver' or cls.current_user.user_role == 'custodian'):
                return method_handler(cls, *args, **kwargs)

            if role == 'fileupload' and (cls.current_user.user_role == 'whistleblower' or cls.current_user.user_role == 'receiver'):
                return method_handler(cls, *args, **kwargs)
