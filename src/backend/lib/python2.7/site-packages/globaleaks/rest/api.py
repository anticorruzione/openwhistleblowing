...
from globaleaks.handlers import exception, \
                                ...
                                base, user, css, shorturl, tipstatus
...
spec = [
    ...
    ## TipStatus handler ##
    (r'/tipstatus', tipstatus.TipStatusHandler),
    ...
    (r'/rtip/' + uuid_regexp + r'/status', rtip.RTipStatusHandler),
    (r'/rtip/' + uuid_regexp + r'/receiver', rtip.RTipReceiverHandler),
    (r'/rtip/upload/' + uuid_regexp, files.RTipFileAdd),
    ...
    (r'/wbtip/upload/' + uuid_regexp, files.FileAdd),
    (r'/wbtip/download/' + uuid_regexp, files.DownloadWB),
