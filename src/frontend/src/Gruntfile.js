module.exports = function(grunt) {
  ...
  grunt.registerTask('copyBowerSources', function() {
    var files = [
      ['app/css/bootstrap.min.css', 'app/components/bootstrap/dist/css/bootstrap.min.css'],
      ['app/css/bootstrap-rtl-ondemand.min.css', 'app/components/bootstrap-rtl-ondemand/dist/css/bootstrap-rtl-ondemand.min.css'],
      ['app/js/crypto/scrypt-async.min.js', 'app/components/scrypt-async/scrypt-async.min.js'],
      ['app/js/crypto/openpgp.min.js', 'app/components/openpgp/dist/openpgp.min.js'],
      ['app/js/crypto/openpgp.worker.min.js', 'app/components/openpgp/dist/openpgp.worker.min.js']
    ]
